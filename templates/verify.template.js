...
const verificationEmailTemplate = (req) => {
  return `
        <!DOCTYPE html>
        ...
        * {
        ...
        <p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:30px;">Account Verified</span></p>
        </div>
        </div>
        </td>
        </tr>
        ...
        <p style="padding-inline: 100px; font-size: 14px; text-align: center;"><span style="background-color:transparent;">Yaay! Your account has been verified.</span></p>
        </div>
        </div>
        </td>
        </tr>
